...
var regex=new RegExp(val);for(i in this.getSheets()){if(regex.test(this.getSheets()[i].href)){this.styleSheet=i;if(typeof this.getSheets()[i]!='undefined'){return this.getSheets()[i];}}}},toggle:function(file){var exceptions=['prefwindow','errorwindow','.browsebutton div','.browsebutton div div','.htmlbutton','.menu','.menu div','.menusmall div','.items li a','.defaultbuttonsmall','.defaultbuttonsmall div','.defaultbuttonsmall div div','.defaultbutton','.defaultbutton div','.defaultbutton div div'];if(jQuery.browser.msie){var stylesheet=this.getStylesheet(file);if(!stylesheet)
